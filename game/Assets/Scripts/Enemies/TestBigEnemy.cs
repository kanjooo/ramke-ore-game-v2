...
public class TestBigEnemy : MonoBehaviour
{
    ...
    private void AttackPlayer()
    {
        ...
        if (!alreadyAttacked)
        {
            Vector3 direction = ghoulHead.position;
            Vector3 relativePos = ghoulHead.position - player.position;
    ...
    private void Chasing()
    {
        ...
        {
            animation.Play("Run");
            var chaseSound = navMeshAgent.GetComponent<ChaseSound>();
